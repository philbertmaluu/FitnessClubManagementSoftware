...
//     swal({
//         title: "Are you sure to delete ?", text: "You will not be able to recover this imaginary file !!",
//         type: "warning", showCancelButton: !0, confirmButtonColor: "#DD6B55", confirmButtonText: "Yes, delete it !!",
//         cancelButtonText: "No, cancel it !!", closeOnConfirm: !1, closeOnCancel: !1
//     }, function (e) {
//         e ? swal("Deleted !!",
//             "Hey, your imaginary file has been deleted !!", "success") :
...
//     swal({
//         title: "Sweet !!", text:
//             "<span style='color:#ff0000'>Hey, you are using HTML !!<span>",
//         html: !0
//     })
// },
...
//     swal({
//         title: "Enter an input !!", text: "Write something interesting !!", type: "input", showCancelButton: !0,
//         closeOnConfirm: !1, animation: "slide-from-top", inputPlaceholder: "Write something"
...
//     swal({
//         title: "Sweet ajax request !!", text: "Submit to run ajax request !!", type: "info",
