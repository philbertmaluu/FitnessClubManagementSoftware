                    ...
                    <div class="container-fluid">
                        ...
                        <!-------row begins------>
                            <div class="row">
                              ...
                              <div class="col-xl-7 col-xxl-3 col-lg-3 col-sm-4">
                                <div class="d-flex flex-wrap">
                                 <div class="card m-4" style="flex: 1 1 30%;">
                                      ...
                                      <h5 class="card-title ">MEALS</h5>
                                        <div class="card-title">
                                         ...
                                         <a href="java-script void" class="badge badge-danger sweet-confirm"><span><i class="fa fa-trash color-light"></i></span></a>
                                            ...
                                            <!------------card body------------------------------------------------------------------>
                                        <div class="card-body d-flex flex-wrap align-items-center justify-content-center" style="margin-right: 5rem">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="form-check form-check-inline">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" class="form-check-input" name="carbohydrate" value="1"
                                                                                            >Carbohydrate
                                                                                    </label>
                                                                                </div>
                                                                                <div class="form-check form-check-inline">
                                                                                ...
                                                                                <div class="form-check form-check-inline disabled">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" class="form-check-input" name="vitamins" value="1"
                                                                                            >Vitamins
                                                                                    </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-check form-check-inline disabled">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" class="form-check-input" name="fats" value="1"
                                                                                            >Fats
                                                                                    </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-check form-check-inline disabled">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" class="form-check-input" name="dairyproducts" value="1"
                                                                                            >Dairyproducts
                                                                                    </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-check form-check-inline disabled">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" class="form-check-input" name="fruits" value="1"
                                                                                            >Fruits
                                                                                    </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-check form-check-inline disabled">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" class="form-check-input" name="water" value="1"
                                                                                            >Water
                                                                                    </label>
                                                                                </div>
...
=======
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
                    @foreach($mealplans as $mealplan)
                    <div class="col-xl-5 col-xxl-3 col-lg-4 col-sm-6">
                        <div class="d-flex flex-wrap">
